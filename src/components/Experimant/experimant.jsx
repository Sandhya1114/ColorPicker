...
//   const [originalColor, setOriginalColor] = useState('#ff0000');
...
//     const origColor = hexToRgb(originalColor);
//     const replacementColor = hexToRgb(newColor);
...
//         const adjustedR = Math.min(255, Math.round(replacementColor.r * brightnessRatio));
//         const adjustedG = Math.min(255, Math.round(replacementColor.g * brightnessRatio));
//         const adjustedB = Math.min(255, Math.round(replacementColor.b * brightnessRatio));
...
//                 //  src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/998cec29-2537-4ebf-8cd2-f10bcedb2e19.png"
//                  />
//               ) : (
//                 <div style={styles.uploadText}>
//                   <img 
//                     src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/f0847e1b-d202-4336-ba4b-d52ac158a28b.png" 
//                     alt="Upload icon" 
...
//               style={styles.previewImage}
//             //  src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/0e7af885-6dad-4b3c-8b76-ad9957a21601.png"
//             />
//           ) : (
//             <div style={styles.emptyPreview}>
//               <img 
//                 src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/55bb16d7-45a3-4384-a53a-f82435b25951.png" 
...
//   const [selectedOriginalColor, setSelectedOriginalColor] = useState('#ff0000');
//   const [newColor, setNewColor] = useState('#0000ff');
//   const [image, setImage] = useState(null);
//   const [processedImage, setProcessedImage] = useState(null);
//   const [isProcessing, setIsProcessing] = useState(false);
...
//           setSelectedOriginalColor(dominantColors[0]); // Set the first color as selected
//         };
//         img.src = event.target.result;
//       };
//       reader.readAsDataURL(file);
...
//     if (newColor && selectedOriginalColor) {
//       setColorReplacements([...colorReplacements, { original: selectedOriginalColor, replacement: newColor }]);
//       setNewColor('#0000ff'); // Reset new color input after adding
//     }
//   };
...
//               <div 
//                 key={index} 
//                 style={{ ...styles.colorSwatch, backgroundColor: color, border: selectedOriginalColor === color ? '2px solid black' : 'none' }}
//                 onClick={() => setSelectedOriginalColor(color)}
//               />
//             ))}
//           </div>
//         </div>
...
//         <button onClick={addColorReplacement} style={styles.addButton}>
